            ...
            >
                {!imageUrl ? (
                    <label htmlFor={inputId} className="flex flex-col items-center justify-center text-gray-500 cursor-pointer w-full h-full text-center">
                        ...
                        <p className="mb-1 text-xs font-semibold">{t('uploader.clickOrDrag')}</p>
                    ...
                    <>
                        ...
                        <button onClick={onClear} className="absolute top-2 right-2 z-10 p-1 bg-black/50 backdrop-blur-sm rounded-full text-white hover:bg-red-600 transition-colors" aria-label={t('uploader.removeImageAriaLabelTemplate', { title })}>
